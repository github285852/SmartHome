...
//#define               macRC522_GPIO_CS_CLK                      RCC_APB2Periph_SPI1
//#define               macRC522_GPIO_CS_PORT    	                GPIOA			   
//#define               macRC522_GPIO_CS_PIN		                  GPIO_Pin_4
//#define               macRC522_GPIO_CS_Mode		                  GPIO_Mode_AF
...
/*********************************** RC522 函数宏定义*********************************************/
#define          macRC522_CS_Enable()         GPIO_ResetBits ( GPIOB, GPIO_Pin_14 )
#define          macRC522_CS_Disable()        GPIO_SetBits ( GPIOB, GPIO_Pin_14 )

#define          macRC522_Reset_Enable()      GPIO_ResetBits( GPIOG, GPIO_Pin_6 )
#define          macRC522_Reset_Disable()     GPIO_SetBits ( GPIOG, GPIO_Pin_6 )

//#define          macRC522_SCK_0()             GPIO_ResetBits( GPIOA, GPIO_Pin_5 )
//#define          macRC522_SCK_1()             GPIO_SetBits ( GPIOA, GPIO_Pin_5 )

//#define          macRC522_MOSI_0()            GPIO_ResetBits( GPIOA, GPIO_Pin_7 )
//#define          macRC522_MOSI_1()            GPIO_SetBits ( GPIOA, GPIO_Pin_7 )

//#define          macRC522_MISO_GET()          GPIO_ReadInputDataBit ( GPIOA, GPIO_Pin_6 )
